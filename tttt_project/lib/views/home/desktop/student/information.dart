                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                ...
                                LineDetail(
                                    field: "Ngành",
                                    display: currentUser.major.value),
                                const Divider(
                                  thickness: 0.2,
                                  height: 0,
                                  color: Colors.black,
                                ...
                                LineDetail(
                                    field: "Ngày sinh",
                                    display: currentUser.birthday.value),
                                const Divider(
                                  thickness: 0.2,
                                  height: 0,
                                  color: Colors.black,
                                ...
                                LineDetail(
                                    field: "Giới tính",
                                    display: currentUser.gender.value),
                                const Divider(
                                  thickness: 0.2,
                                  height: 0,
                                  color: Colors.black,
                                ...
                                LineDetail(
                                    field: "Điện thoại",
                                    display: currentUser.phone.value),
                                const Divider(
                                  thickness: 0.2,
                                  height: 0,
                                  color: Colors.black,
                                ...
                                LineDetail(
                                    field: "Email",
                                    display: currentUser.email.value),
                              ],
                            )
                          ],
                        ),
...
//             Column(
//               children: [
//                 LineDetail(field: "Họ tên", display: currentUser.name.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
...
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Khóa", display: currentUser.course.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Ngành", display: currentUser.major.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Lớp", display: currentUser.className.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(
//                     field: "Ngày sinh", display: currentUser.birthday.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Giới tính", display: currentUser.gender.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Điện thoại", display: currentUser.phone.value),
//                 const Divider(
//                   thickness: 0.2,
//                   height: 0,
//                   color: Colors.black,
//                 ),
//                 LineDetail(field: "Email", display: currentUser.email.value),
//               ],
//             )
//           ],
//         ),

  ...
  getUserData() async {
    ...
    if (isLoggedIn == true) {
      ...
      if (isExistUser.data() != null) {
        ...
        setState(() {
          nameCBCtrl.text = loadUser.userName!;
          phoneCBCtrl.text = loadUser.phone!;
          emailCBCtrl.text = loadUser.email!;
        });
        currentUser.setCurrentUser(
          setUid: loadUser.uid,
            ...
            child: CustomButton(
              ...
              onTap: () async {
                if (nameCBCtrl.text != currentUser.userName.value ||
                  ...
                  GV.success(context: context, message: 'Thay đổi thành công!');
                } else if (nameCBCtrl.text == currentUser.userName.value &&
                    phoneCBCtrl.text == currentUser.phone.value &&
                    emailCBCtrl.text == currentUser.email.value) {
                  GV.error(context: context, message: 'Không có gì thay đổi!');
                }
              },
            ),
          ),
